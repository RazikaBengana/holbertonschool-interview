...
![Slide_line.png](README-image/slide_line.png)
...
<h3 align="center">
<a href="https://github.com/RazikaBengana/holbertonschool-interview/tree/main/slide_line#eye-about">About</a> •
<a href="https://github.com/RazikaBengana/holbertonschool-interview/tree/main/slide_line#computer-requirements">Requirements</a> •
<a href="https://github.com/RazikaBengana/holbertonschool-interview/tree/main/slide_line#hammer_and_wrench-task">Task</a>
</h3>
...
**`2048 (single line)`** project focuses on implementing a sliding line puzzle.
<br>
The project covers game mechanics and logic.
<br>
<br>
This project has been created by **[Holberton School](https://www.holbertonschool.com/about-holberton)** to enable every student to understand how game logic in `C` works.
...
Given an array of integers, we want to be able to slide & merge it to the left or to the right. <br>
...
- Write a function that slides and merges an array of integers
    ...
    - Where `line` points to an array of integers containing `size` elements, that must be slided & merged to the direction represented by direction.
